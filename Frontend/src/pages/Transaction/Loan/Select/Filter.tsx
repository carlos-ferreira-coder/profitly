...
const Filter = ({
  ...
  const filter = (data: FilterProps) => {
    ...
    const query = {
      installmentMin: data.installmentMin
        ? currencyToNumber(data.installmentMin, 'BRL')
        : undefined,
      installmentMax: data.installmentMax
        ? currencyToNumber(data.installmentMax, 'BRL')
        : undefined,
      monthsMin: data.monthsMin || undefined,
      monthsMax: data.monthsMin || undefined,
            ...
            <Controller
              ...
              render={({ field }) => (
                <InputPattern
                  ...
                  iconPosition="left"
                  format="##"
                  placeholder="Nº de meses minimo"
                />
              )}
            />
          </div>
            ...
            <Controller
              ...
              render={({ field }) => (
                <InputPattern
                  ...
                  iconPosition="left"
                  format="##"
                  placeholder="Nº de meses maximo"
                />
              )}
            />
          </div>
